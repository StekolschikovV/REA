...
class Center extends Component {
    ...
    render() {
        ...
        for (let i = 0; i < this.realEstate.length; i++) {
            ...
            if (e.ownershipForm === this.filter.ownershipForm
                ...
                showRealEstate.push(
                    <li key={i}
                        ...
                        onClick={() => {
                            if (i === this.selectedId) this.props.setSelectedRealEstate('undefined')
                            else this.props.setSelectedRealEstate(i)
                        }}
                        onMouseEnter={() => { this.props.setHoverRealEstate(i) }}
                        onMouseLeave={() => { this.props.rmHoverRealEstate(i) }}>
                        <div className="left">
